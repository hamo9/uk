            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        @else
                        <img src="{{ $user->personal_photo }}" alt="Profile" class="rounded-circle" width="200px" height="200px">
                        @endif
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">{{ $user->family_name }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-md-4 label">{{ __("register.Grandfather's Name") }}</div>
                                    <div class="col-md-8">{{ $user->grandfather_name }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-md-4 label">{{ __("register.Telephone Number") }}</div>
                                    <div class="col-md-8">{{ $user->telephone_number }}</div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <img src="{{ $user->personal_photo }}" alt="{{ __("register.personal photo") }}" class="rounded" width="200px">
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <img src="{{ $user->national_number_card }}" alt="{{ __("register.National Number Card") }}" class="rounded" width="200px">
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <img src="{{ $user->certificate_graduation }}" alt="{{ __("register.Certificate of Graduation") }}" class="rounded" width="200px">
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <img src="{{ $user->experience_certificates }}" alt="{{ __("register.experience certificates") }}" class="rounded" width="200px">
                                    </div>
                                </div>
